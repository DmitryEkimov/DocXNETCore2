...
#pragma warning restore CS1584 // XML comment has syntactically incorrect cref attribute
        ...
        public Border GetBorder(TableBorderType borderType)
        {
            ...
            else
            {
                ...
                try
                {
                    b.Color = Color.FromArgb(int.Parse(color.Value,
                        System.Globalization.NumberStyles.AllowHexSpecifier)); //ColorTranslator.FromHtml(string.Format("#{0}", color.Value));
                }
                catch
                {
                    color.Remove();
    ...
    public class Cell : Container
    {
        ...
        public Color Shading
        {
            get
            {
                ...
                return Color.FromArgb(int.Parse(fill.Value,
                    System.Globalization.NumberStyles.AllowHexSpecifier)); //ColorTranslator.FromHtml(string.Format("#{0}", fill.Value));
            }
