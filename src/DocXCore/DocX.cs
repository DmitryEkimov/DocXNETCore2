...
namespace Novacode
{
    ...
    public class DocX : Container, IDisposable
    {
        ...
        {
            Package templatePackage = Package.Open(templateStream, FileMode.Open, FileAccess.Read);
            try
            {
                ...
                foreach (PackagePart packagePart in templatePackage.GetParts())
                {
                    switch (packagePart.Uri.ToString())
                    {
                        ...
                        default:
                            ...
                            Encoding packagePartEncoding = Encoding.UTF8;
            ...
            finally
            {
                ...
                //Stream test = documentRelsPart.GetStream(FileMode.Open, FileAccess.Read);
